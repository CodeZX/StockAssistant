...
@interface JYAskTableViewController ()<UITableViewDelegate,UITableViewDataSource,JYASKTableViewCellDelegate>
...
@implementation JYAskTableViewController
...
- (void)ds_setupTableView {
    ...
    __weak JYAskTableViewController * weakSelf = self;
