...
@interface JYRegisterViewController () <UITextFieldDelegate>
{
    int randNumber;
}
...
- (void)JY_setUI {
    ...
    [self.loginButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.registerTextField.mas_bottom).offset(40);
...
- (UITextField *)phoneTextField {
    if (!_phoneTextField) {
        ...
        _phoneTextField.leftView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"icon_person"]];
